...
function MudaDesenho(){
    ...
    if((valor=="Áries") || (valor=="Aries") || (valor=="aries") || (valor=="áries") ){
        ...
        imagem.setAttribute("src","img/ofiuco.png");
        imagem.setAttribute("width","500px");
    ...
    else if(valor=="Leandromeda"){
        texto.innerHTML = "O grande Leandromeda";
        imagem.setAttribute("src","img/andromeda.png");
        imagem.setAttribute("width","500px");
        texto2.innerHTML = "Um homem que evidentemente curti muito os cavaleiros,possui uma paixão insaciavel sobre pokémon e comida, e o mais importante,ele manja muito de HTML. " ;
    }
    else{
